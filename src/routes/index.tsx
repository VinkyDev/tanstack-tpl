    ...
    <div className="mx-auto flex min-h-screen max-w-5xl flex-col gap-8 p-6 sm:p-10">
      <section className="space-y-4">
        ...
        <p className="max-w-2xl text-muted-foreground leading-relaxed">
          这是一个完整的 TanStack 技术栈演示模板，展示了 Router、Query、AI、Form、Store、DB、Pacer
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="h-full border-dashed">
          <CardHeader>
            ...
            <CardDescription>
              已内置 Drizzle ORM、Biome、React Compiler、TanStack Devtools 等基础设施
            </CardDescription>
          </CardHeader>
        </Card>
      </section>
      ...
      <footer className="mt-auto pt-8 text-center text-muted-foreground text-xs">
        <p>
          ...
          Open the TanStack Devtools (bottom-right) to inspect router & query state
        </p>
      </footer>
    </div>
  );
